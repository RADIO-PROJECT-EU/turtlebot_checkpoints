...
""" turtlebot_checkpoints.py - Version 1.1 2013-12-20
    ...
    Command a robot to move to waypoints using move_base actions..
...
class TurtlebotCheckpoints():
    def __init__(self):
        ...
        waypoints.append(Pose(Point(0.054, 6.577, 0.0), quaternions[0]))
        waypoints.append(Pose(Point(0.288, 9.822, 0.0), quaternions[1]))
        waypoints.append(Pose(Point(-0.303, 17.777, 0.0), quaternions[2]))
